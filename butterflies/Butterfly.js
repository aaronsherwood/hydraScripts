...
var destination = new THREE.Vector3(0,0,-150);
...
bodyTexture2 = new THREE.TextureLoader().load('/Users/ags419/Downloads/butterbod0.png');
...
wingTexture5 = new THREE.TextureLoader().load('/Users/ags419/Downloads/butterwing2.png');
...
function Butterfly() {
  ...
  var confs = [
    ...
    { bodyTexture: bodyTexture2, bodyW: 8, bodyH: 14, bodyY: 1, wingTexture: wingTexture5, wingW: 10, wingH: 15, wingX: 5.5 },
...
Butterfly.prototype.initTween = function () {
  var duration = limit(conf.velocityLimit - this.velocity.length(), 0.5, 1.5) * 1000;
...
Butterfly.prototype.move = function () {
  ...
  this.o3d.position.x+=this.velocity.x;
  this.o3d.position.y+=this.velocity.y;
  this.o3d.position.z+=this.velocity.z;
  if (this.o3d.position.z> 0) {
    // this.o3d.position.z=-30;
    // this.velocity.z*=-1;
  }
  // if (this.o3d.position.x > 30 || this.o3d.position.x <-30)
  //   this.o3d.position.x*=-1;
};
